...
export class FlyingState extends PlasmaProjectileState {
  ...
  createCurve() {
    const projectileBody =
      this.machine.enemy.getComponent<PlasmaProjectileBody>("body");
